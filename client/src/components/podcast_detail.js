      ...
      <div className='podcast_detail_interface'>
        ...
        <section className='podcast_id_container'>   
          ...
          <div className='podcast_id'>
              ...
              <a href="#AllTracks"><img  src='/play1.jpg'  id='play_id' /></a>
              ...
              <button  id="ReportButton"  style={{marginLeft:"100px"}} onClick={handleReportClick}>Report this podcast</button>
          </div>  
